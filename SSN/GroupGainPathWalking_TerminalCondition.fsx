...
//let fileSubName = "ProteinDataSet_Path23"
...
//            p.Insert id (fst matrixG_origin.[i].[ii]) // load all calculated gains
//        p
...
//let treeMM = readMM data23 data23.Length
//treeMM.GroupGain
//let walk = applySSN (data23) data23.Length
//walk.GroupGain
//let combi = applySSNcombi (data23) data23.Length
//combi.GroupGain
...
//Plots.drawKinetik (combi |> Tree.findNode ["23";"3";"3";"mix|p30|p53"]) timeAra "subbin 23.3.3.mix|p30|p53" |> Chart.Show
...
//File.AppendAllLines((sprintf "%s%s.txt" pathFile "newDataDictionary"), neader :: lines)
