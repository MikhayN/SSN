...
let lines = 
    ...
    |> List.map (fun path -> 
        ...
        printfn "%s %f %f %f %f %f %f %i %f" path combi.GroupGain timeCombi dxcC walk.GroupGain timeWalk dxcW (Tree.treeComparison combi walk) (timeCombi/timeWalk)
        sprintf "%s\t%f\t%f\t%f\t%f\t%f\t%f\t%i\t%f" path combi.GroupGain timeCombi dxcC walk.GroupGain timeWalk dxcW (Tree.treeComparison combi walk) (timeCombi/timeWalk)
